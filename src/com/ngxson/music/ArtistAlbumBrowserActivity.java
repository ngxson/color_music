...
import com.ngxson.music.QueryBrowserActivity.QueryListAdapter.QueryHandler;
        ...
        implements View.OnCreateContextMenuListener, MusicUtils.Defs, ServiceConnection
{
    ...
    public boolean onChildClick(ExpandableListView parent, View v, int groupPosition, int childPosition, long id) {
        ...
        intent.setDataAndType(Uri.EMPTY, "vnd.ngxson.cursor.dir/track");
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        menu.add(1, MediaPlaybackActivity.SETTING, 0, R.string.setting).setIcon(R.drawable.ic_menu_preferences);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case MediaPlaybackActivity.SETTING: {
                intent = new Intent();
