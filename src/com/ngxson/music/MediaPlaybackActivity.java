...
import com.ngxson.music.IMediaPlaybackService;
import com.ngxson.music.MusicUtils.ServiceToken;
    ...
    View.OnTouchListener, View.OnLongClickListener
{
    ...
    public void onCreate(Bundle icicle)
    {
        ...
        //root.setBackgroundColor(android.R.color.transparent);
        //

        mCurrentTime = (TextView) findViewById(R.id.currenttime);
        mAlbumArtist = (TextView) findViewById(R.id.album_artist);
        mTotalTime = (TextView) findViewById(R.id.totaltime);
        mProgress = (ProgressBar) findViewById(android.R.id.progress);
        mAlbum = (ImageButton) findViewById(R.id.album);
        mAlbum.setScaleType(ScaleType.FIT_XY);
        mTrackName = (TextView) findViewById(R.id.trackname);
        mPlayBg = (ImageView) findViewById(R.id.play_background);
        mPlayBg.setScaleType(ScaleType.CENTER_CROP);
        ...
        mQueueButton = (ImageButton) findViewById(R.id.album);
    ...
    private View.OnClickListener mQueueListener = new View.OnClickListener() {
        public void onClick(View v) {
            startActivity(
                    ...
                    .setDataAndType(Uri.EMPTY, "vnd.ngxson.cursor.dir/track")
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        if (MusicUtils.getCurrentAudioId() >= 0) {
            ...
            //FIXME
            menu.add(1, SETTING, 0, R.string.setting).setIcon(R.drawable.ic_menu_preferences);
...
*/
    ...
    private static final int ALBUM_ART_BACKUP = 11;
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                case ALBUM_ART_DECODED:
                	...
                	//Bitmap bg = bm;
                	//Bitmap bg = fastblur(bm, 20);
                	Bitmap bg = getAveColor(bm);
                	mPlayBg.setImageBitmap(bg);
    ...
    private Bitmap getAveColor(Bitmap bm) {
    	return Bitmap.createScaledBitmap(bm, 10, 10, true);
    }
    ...
    private void updateTrackInfo() {
        ...
        try {
            ...
            if (songid < 0 && path.toLowerCase().startsWith("http://")) {
            	...
            	((View) mAlbumArtist.getParent()).setVisibility(View.INVISIBLE);
            	...
            	((View) mAlbumArtist.getParent()).setVisibility(View.VISIBLE);
                ...
                mAlbumArtist.setText(artistName + " - " + albumName);
