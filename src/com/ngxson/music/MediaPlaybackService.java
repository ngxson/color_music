...
public class MediaPlaybackService extends Service {
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        if (intent != null) {
            ...
            if (CMDNEXT.equals(cmd) || NEXT_ACTION.equals(action)) {
                ...
                pause();
                if (intent.getIntExtra("Music", 0) == 3) {
                    stopForeground(true);
                }
                mPausedByTransientLossOfFocus = false;
                seek(0);
    ...
    private void notifyChange(String what) {
        ...
        if (what.equals(PLAYSTATE_CHANGED)) {
            ...
            boolean l = prefs.getBoolean("lock_album", true);
            if (l) {
            	//FIXME
            	if(b != null) {
            		ed.putBitmap(MetadataEditor.BITMAP_KEY_ARTWORK, b);
            	} else {
                	Bitmap unknown = BitmapFactory.decodeResource(getApplicationContext().getResources(),
                            R.drawable.albumart_mp_unknown);
                	ed.putBitmap(MetadataEditor.BITMAP_KEY_ARTWORK, unknown);
            	}
            }
            ed.apply();
        }
    ...
    private void updateNotification() {
        ...
        // show notification button when android 4.1+
    	} else {
            Bitmap b = MusicUtils.getArtwork(this, getAudioId(), getAlbumId(), false);
            ...
            if (b != null) {
            	...
            	Bitmap unknown = BitmapFactory.decodeResource(getApplicationContext().getResources(),
                        R.drawable.albumart_mp_unknown);
                views.setImageViewBitmap(R.id.status_bar_album_art, unknown);
                bigViews.setImageViewBitmap(R.id.status_bar_album_art, unknown);
            ...
            intent = new Intent(MediaPlaybackService.PAUSE_ACTION);
            ...
            views.setOnClickPendingIntent(R.id.status_bar_next, pendingIntent);
            bigViews.setOnClickPendingIntent(R.id.status_bar_next, pendingIntent);
            ...
            bigViews.setOnClickPendingIntent(R.id.status_bar_prev, pendingIntent);
            ...
            views.setOnClickPendingIntent(R.id.status_bar_collapse, pendingIntent);
            bigViews.setOnClickPendingIntent(R.id.status_bar_collapse, pendingIntent);
            ...
            status.contentIntent = PendingIntent
                    .getActivity(this, 0, new Intent("com.android.music.PLAYBACK_VIEWER")
